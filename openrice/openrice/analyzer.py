...
file_list.append("data_2355000");
file_list.append("data_2355050");
file_list.append("data_2355100");
file_list.append("data_2355150");
print str(file_list);
...
for count in range(0,int(number_of_file) + 4):
	print "file " + DIR + file_list[count];
	...
	for count_record in range(0,len(record_json)):
		...
		date_time = datetime.datetime.strptime(record_json[count_record]["date"],'%Y-%m-%d');
		worksheet.write_datetime(count_row,3,date_time,date_format);
